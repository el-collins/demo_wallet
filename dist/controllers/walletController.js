    ...
    constructor() {
        this.createWallet = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const wallet = yield walletService_1.walletService.createWallet(id, email);
                (0, response_1.handleResponse)(res, 201, "Wallet created successfully", wallet);
            }
            catch (error) {
        ...
        this.fundWallet = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (0, response_1.handleResponse)(res, 200, "Wallet funded successfully", {
                    transaction,
                });
            }
            catch (error) {
                ...
                (0, response_1.handleError)(res, "Failed to fund wallet");
            }
        });
